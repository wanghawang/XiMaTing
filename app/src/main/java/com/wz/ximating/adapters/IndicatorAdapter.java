...
public class IndicatorAdapter extends CommonNavigatorAdapter {
    ...
    private IndicatorTapClickListener mListener;

    public IndicatorAdapter(Context context) {
        mTitles = context.getResources().getStringArray(R.array.indicator_titles);
    }
    ...
    public void setOnIndicatorTapClickListener(IndicatorTapClickListener listener){
        this.mListener = listener;
    }

    public interface IndicatorTapClickListener{
